          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-xl bg-white border-none rounded-[2.5rem] shadow-2xl p-0 overflow-hidden">
              <div className="bg-[#064e3b] p-8 text-white relative overflow-hidden">
                ...
                <h2 className="text-2xl font-black uppercase tracking-tighter mb-1 relative z-10">Stock In Protocol</h2>
                <p className="text-emerald-400 text-[10px] font-black uppercase tracking-widest relative z-10">Logistics Deployment System</p>
              </div>
              ...
              <div className="p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-emerald-900/60 ml-1">Asset Identity (UUID)</label>
                    <div className="relative">
                      <Fingerprint className="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-900/20" size={18} />
                      <input 
                  ...
                  {/* Warehouse ID Input */}
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-emerald-900/60 ml-1">Warehouse Sector</label>
                    <div className="relative">
                      <Warehouse className="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-900/20" size={18} />
                      <input 
                ...
                {/* Quantity Input */}
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-emerald-900/60 ml-1">Deployment Quantity</label>
                  <div className="relative">
                    <Plus className="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-900/20" size={18} />
                    <input 
                      type="number"
                      value={form.quantity}
                ...
                {/* Reference Input */}
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-emerald-900/60 ml-1">Reference Notes</label>
                  <textarea 
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-emerald-50/50 border-b border-emerald-900/5">
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-emerald-900/40">Product Description</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-emerald-900/40">Warehouse Cluster</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-emerald-900/40 text-right">Available Stock</th>
              </tr>
            </thead>
              ...
              <tr className="hover:bg-emerald-50/30 transition-colors group">
                <td className="px-8 py-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-black text-emerald-900 uppercase tracking-tight">Solar Panel 550W</p>
                      <p className="text-[9px] font-bold text-emerald-900/30 uppercase tracking-tighter">Inventory Code: SLP-550</p>
                    </div>
                  </div>
                </td>
                <td className="px-8 py-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase text-emerald-900/60">Main Warehouse</span>
                  </div>
                </td>
