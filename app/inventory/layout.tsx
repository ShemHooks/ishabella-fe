...
import { getUser } from '@/server/api/app';
    ...
    <div className="flex h-screen w-full overflow-hidden bg-[#f8fafc]">
      ...
      <aside className="w-72 bg-[#022c22] text-white flex flex-col border-r border-emerald-900/20 shadow-2xl h-full shrink-0">
        ...
        <div className="p-8 pb-12">
          ...
          <p className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald-100/30 mt-1"></p>
        </div>
            ...
            >
              <div className="flex items-center gap-4">
                <Icon
                  ...
                  className={
                    active ? 'text-white' : 'text-emerald-500/50 group-hover:text-emerald-400'
                  }
                />
        ...
        <div className="p-6 mt-auto">
          <div className="bg-emerald-950/50 rounded-3xl p-5 border border-emerald-500/10">
            ...
            <button
              className="w-full flex items-center justify-center gap-2 p-3 bg-white/5 hover:bg-rose-500/10 hover:text-rose-400 rounded-xl transition-all text-[9px] font-black uppercase tracking-[0.2em] text-emerald-100/30"
        ...
        <header className="h-20 border-b border-emerald-900/5 bg-white/50 backdrop-blur-md flex items-center px-10 shrink-0 justify-end">
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-[10px] font-black uppercase text-emerald-900">Inventory Manager</p>
              <p className="text-[8px] font-bold text-emerald-900/40 uppercase">{userName}</p>
            </div>
